...
const AyurvedicIntelligenceCenter = () => {
    ...
    const mockResults = [
      {
        ...
        type: 'Article',
        excerpt:
          'Discover warming, grounding foods that help balance Vata dosha during the dry, windy autumn season.',
        relevance: 95
      },
      {
        ...
        type: 'Video',
        excerpt:
          'Learn how to assess and strengthen digestive capacity according to Ayurvedic principles.',
        relevance: 88
      },
      {
        ...
        type: 'Research',
        excerpt:
          "Clinical studies on turmeric's anti-inflammatory properties and traditional Ayurvedic applications.",
        relevance: 82
      }
    ];
  ...
  const renderActiveSection = () => {
    switch (activeSection) {
      ...
      case 'search':
        return (
          <SearchAndFilter onSearch={handleSearch} onFilter={handleSearch} />
        );
      default:
        return <OverviewSection />;
    }
      ...
      <div className="text-center bg-gradient-to-br from-brand-ivory via-brand-cream to-brand-sage/10 rounded-3xl p-12 border border-brand-gold/20">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-text-secondary mb-8 leading-relaxed">
            with modern nutritional science. Explore interactive learning modules,
            expert insights, and practical tools designed for healthcare
            professionals and wellness enthusiasts.
          </p>
      ...
      <div className="bg-gradient-to-r from-primary/5 to-brand-sage/5 rounded-2xl p-8 border border-primary/10">
        <div className="text-center mb-8">
          ...
          <p className="text-text-secondary">
            Thousands of healthcare professionals are already transforming their
            practice
          </p>
        </div>
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="ayurveda, nutrition, dosha, learning, healthcare, holistic medicine, food energetics"
        />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="text-center">
              <p className="text-sm opacity-80">
                © {new Date()?.getFullYear()} AyurNutri Platform. Bridging Ancient
